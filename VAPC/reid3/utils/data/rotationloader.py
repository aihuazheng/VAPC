    ...
    def get_iterator(self, epoch=0):
        ...
        if self.unsupervised:
            ...
            def _load_function(idx):
                ...
                img0,fname ,index,camid = self.dataset[idx]
                ...
                categorical_label=torch.LongTensor([index, index, index, index])
                return torch.stack(rotated_imgs, dim=0),categorical_label, rotation_labels
